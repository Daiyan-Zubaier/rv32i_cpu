...
.PHONY: lint lint-alu lint-mux lint-control-logic program sim-program sim-alu sim-mux sim-control-logic sim-core sim-imem sim-dmem
...
sim-core: $(PROGRAM)
	...
	./obj_dir/Vrv32i_core
	python3 tools/dealias_vcd.py waves/rv32i_core.vcd
